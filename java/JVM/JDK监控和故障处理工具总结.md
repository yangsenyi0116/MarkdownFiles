- JDK 监控和故障处理工具总结
  - JDK 命令行工具
    - [`jps`:查看所有 Java 进程](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#jps查看所有-java-进程)
    - [`jstat`: 监视虚拟机各种运行状态信息](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#jstat-监视虚拟机各种运行状态信息)
    - [`jinfo`: 实时地查看和调整虚拟机各项参数](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#-jinfo-实时地查看和调整虚拟机各项参数)
    - [`jmap`:生成堆转储快照](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#jmap生成堆转储快照)
    - [**`jhat`**: 分析 heapdump 文件](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#jhat-分析-heapdump-文件)
    - [**`jstack`** :生成虚拟机当前时刻的线程快照](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#jstack-生成虚拟机当前时刻的线程快照)
  - JDK 可视化分析工具
    - JConsole:Java 监视与管理控制台
      - [连接 Jconsole](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#连接-jconsole)
      - [查看 Java 程序概况](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#查看-java-程序概况)
      - [内存监控](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#内存监控)
      - [线程监控](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#线程监控)
    - [Visual VM:多合一故障处理工具](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/jvm/JDK监控和故障处理工具总结.md#visual-vm多合一故障处理工具)
...
[![连接 Jconsole](assets/68747470733a2f2f6d792d626c6f672d746f2d7573652e6f73732d636e2d6265696a696e672e616c6979756e63732e636f6d2f323031392d362f314a436f6e736f6c652545382542462539452545362538452541352e706e67.png)](https://camo.githubusercontent.com/a108b0807e218d06448dd7b3b86821299b498fcf/68747470733a2f2f6d792d626c6f672d746f2d7573652e6f73732d636e2d6265696a696e672e616c6979756e63732e636f6d2f323031392d362f314a436f6e736f6c652545382542462539452545362538452541352e706e67)
