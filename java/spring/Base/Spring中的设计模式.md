...
典型的例子有spring与[mybatis](https://mp.weixin.qq.com/s?__biz=MzUzMTA2NTU2Ng==&mid=2247488132&idx=3&sn=da485b7e53fc1a95acad6baf06892591&scene=21#wechat_redirect)的结合。
...
```java
public abstractclass ApplicationEvent extends EventObject {
...
JDBC的抽象和对[Hibernate](https://mp.weixin.qq.com/s?__biz=MzUzMTA2NTU2Ng==&mid=2247488355&idx=3&sn=6296a7ad0d7916a542b0484c22dcdf24&scene=21#wechat_redirect)的集成，都采用了一种理念或者处理方式，那就是模板方法模式与相应的Callback接口相结合。

采用模板方法模式是为了以一种统一而集中的方式来处理资源的获取和释放，以JdbcTempalte为例:

```java
public abstractclass JdbcTemplate {
