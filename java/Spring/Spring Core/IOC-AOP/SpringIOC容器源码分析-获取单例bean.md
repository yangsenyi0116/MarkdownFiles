...
本节涉及到了 FactoryBean 和后置处理两个特性，关于这两个特性，不熟悉的同学可以参考我在[导读](http://www.coolblog.xyz/2018/05/30/Spring-IOC-容器源码分析系列文章导读/)一文中的说明，这里就不过多解释了。