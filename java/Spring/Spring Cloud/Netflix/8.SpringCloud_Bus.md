...
![Paste_Image.png](assets/2279594-c1fe748f1d25af70.png)

重新读取配置文件：

![Paste_Image.png](assets/2279594-57874b46c40c9916.png)
...
此时的架构图：![Paste_Image.png](assets/2279594-9a119d83cf90069f.png)
...
Tracing Bus Events： 需要设置：spring.cloud.bus.trace.enabled=true，如果那样做的话，那么Spring Boot TraceRepository（如果存在）将显示每个服务实例发送的所有事件和所有的ack,比如：（来自官网）
