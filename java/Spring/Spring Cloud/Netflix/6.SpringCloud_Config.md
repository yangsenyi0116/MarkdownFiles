用配置服务来保存各个服务的配置文件。它就是Spring Cloud Config。
...
![Azure (assets/2279594-40ecbed6d38573d9.png).png](https://www.fangzhipeng.com/img/jianshu/2279594-40ecbed6d38573d9.png)