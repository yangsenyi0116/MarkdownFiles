...
public class MultiThread {
    public static void main(String[] args) {
        ...
        for (ThreadInfo threadInfo : threadInfos) {
            System.out.println("[" + threadInfo.getThreadId() + "]" + threadInfo.getThreadState() + ":" + threadInfo.getThreadName());
        }
    }
}
```
...
![image-20200414193446865](assets/image-20200414193446865.png)
