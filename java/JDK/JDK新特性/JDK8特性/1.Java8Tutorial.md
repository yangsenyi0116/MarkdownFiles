- Java 8 Tutorial
  - [接口的默认方法(Default Methods for Interfaces)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#接口的默认方法default-methods-for-interfaces)
  - [Lambda表达式(Lambda expressions)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#lambda表达式lambda-expressions)
  - [函数式接口(Functional Interfaces)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#函数式接口functional-interfaces)
  - [方法和构造函数引用(Method and Constructor References)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#方法和构造函数引用method-and-constructor-references)
  - Lamda 表达式作用域(Lambda Scopes)
    - [访问局部变量](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#访问局部变量)
    - [访问字段和静态变量](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#访问字段和静态变量)
    - [访问默认接口方法](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#访问默认接口方法)
  - 内置函数式接口(Built-in Functional Interfaces)
    - [Predicates](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#predicates)
    - [Functions](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#functions)
    - [Suppliers](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#suppliers)
    - [Consumers](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#consumers)
    - [Comparators](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#comparators)
  - [Optionals](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#optionals)
  - Streams(流)
    - [Filter(过滤)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#filter过滤)
    - [Sorted(排序)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#sorted排序)
    - [Map(映射)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#map映射)
    - [Match(匹配)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#match匹配)
    - [Count(计数)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#count计数)
    - [Reduce(规约)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#reduce规约)
  - Parallel Streams(并行流)
    - [Sequential Sort(串行排序)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#sequential-sort串行排序)
    - [Parallel Sort(并行排序)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#parallel-sort并行排序)
  - [Maps](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#maps)
  - Date API(日期相关API)
    - [Clock](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#clock)
    - [Timezones(时区)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#timezones时区)
    - [LocalTime(本地时间)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#localtime本地时间)
    - [LocalDate(本地日期)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#localdate本地日期)
    - [LocalDateTime(本地日期时间)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#localdatetime本地日期时间)
  - [Annotations(注解)](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#annotations注解)
  - [Whete to go from here?](https://github.com/KermiSweet/JavaGuide/blob/master/docs/java/What's New in JDK8/Java8Tutorial.md#whete-to-go-from-here)
...
![image-20200421224345587](assets/image-20200421224345587.png)
